...
A real-time chat application built by Rachi. Connect with friends, create chat rooms, and communicate instantly.

This project combines modern frontend and backend technologies to deliver a seamless real-time messaging experience.
